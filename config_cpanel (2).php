...
// ============================================
// File ini sudah dikonfigurasi untuk cPanel
// PENTING: Ganti URL di baris 9 sesuai domain cPanel Anda
// Contoh: 
//   - https://e-cuti-fst.my.id/api
//   - https://domainanda.com/api
//   - http://domainanda.com/api (jika HTTPS tidak tersedia)
...
{
    return isset($_SESSION['admin_token']) && isset($_SESSION['admin_user']) &&
        ($_SESSION['admin_user']['role'] === 'admin' ||
            $_SESSION['admin_user']['role'] === 'wkdu' ||
            $_SESSION['admin_user']['role'] === 'approved_1' ||
            $_SESSION['admin_user']['role'] === 'approved_2');
}
